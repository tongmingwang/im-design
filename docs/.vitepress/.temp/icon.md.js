import { useSSRContext, resolveComponent, resolveDirective, withCtx, createVNode, unref, mergeProps, withDirectives, createBlock, openBlock, createTextVNode, toDisplayString, Fragment, renderList } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderStyle, ssrRenderList, ssrGetDirectiveProps, ssrInterpolate } from "vue/server-renderer";
const id = "4935783";
const name = "im-icons";
const font_family = "im-icon";
const css_prefix_text = "im-icon-";
const description = "";
const glyphs = [
  {
    icon_id: "4765725",
...
const __pageData = JSON.parse('{"title":"Icon 图标","description":"","frontmatter":{},"headers":[],"relativePath":"icon.md","filePath":"icon.md","lastUpdated":1749913367000}');
const __default__ = { name: "icon.md" };
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ImRow = resolveComponent("ImRow");
      const _component_im_icon = resolveComponent("im-icon");
      const _component_ImCol = resolveComponent("ImCol");
      const _component_ImIcon = resolveComponent("ImIcon");
      const _directive_ripple = resolveDirective("ripple");
      _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="icon-图标" tabindex="-1">Icon 图标 <a class="header-anchor" href="#icon-图标" aria-label="Permalink to &quot;Icon 图标&quot;">​</a></h1><p>ImDesign 提供常用的图标，方便你在项目快速使用，内存占用极小兼容性好 19kb 的大小。</p><h2 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h2>`);
      _push(ssrRenderComponent(_component_ImRow, { gutter: 8 }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_im_icon, { name: "info-circle" }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_im_icon, {
              name: "info-circle",
              size: "24px"
            }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_component_im_icon, { name: "info-circle" }),
              createVNode(_component_im_icon, {
                name: "info-circle",
                size: "24px"
              })
            ];
...
<span class="line"><span style="${ssrRenderStyle({ "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" })}">  &lt;</span><span style="${ssrRenderStyle({ "--shiki-light": "#22863A", "--shiki-dark": "#85E89D" })}">ImRow</span><span style="${ssrRenderStyle({ "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" })}"> :</span><span style="${ssrRenderStyle({ "--shiki-light": "#6F42C1", "--shiki-dark": "#B392F0" })}">gutter</span><span style="${ssrRenderStyle({ "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" })}">=</span><span style="${ssrRenderStyle({ "--shiki-light": "#032F62", "--shiki-dark": "#9ECBFF" })}">&quot;</span><span style="${ssrRenderStyle({ "--shiki-light": "#005CC5", "--shiki-dark": "#79B8FF" })}">8</span><span style="${ssrRenderStyle({ "--shiki-light": "#032F62", "--shiki-dark": "#9ECBFF" })}">&quot;</span><span style="${ssrRenderStyle({ "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" })}">&gt;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" })}">    &lt;</span><span style="${ssrRenderStyle({ "--shiki-light": "#22863A", "--shiki-dark": "#85E89D" })}">ImIcon</span><span style="${ssrRenderStyle({ "--shiki-light": "#6F42C1", "--shiki-dark": "#B392F0" })}"> name</span><span style="${ssrRenderStyle({ "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" })}">=</span><span style="${ssrRenderStyle({ "--shiki-light": "#032F62", "--shiki-dark": "#9ECBFF" })}">&quot;info-circle&quot;</span><span style="${ssrRenderStyle({ "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" })}"> /&gt;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" })}">    &lt;</span><span style="${ssrRenderStyle({ "--shiki-light": "#22863A", "--shiki-dark": "#85E89D" })}">ImIcon</span><span style="${ssrRenderStyle({ "--shiki-light": "#6F42C1", "--shiki-dark": "#B392F0" })}"> name</span><span style="${ssrRenderStyle({ "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" })}">=</span><span style="${ssrRenderStyle({ "--shiki-light": "#032F62", "--shiki-dark": "#9ECBFF" })}">&quot;info-circle&quot;</span><span style="${ssrRenderStyle({ "--shiki-light": "#6F42C1", "--shiki-dark": "#B392F0" })}"> size</span><span style="${ssrRenderStyle({ "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" })}">=</span><span style="${ssrRenderStyle({ "--shiki-light": "#032F62", "--shiki-dark": "#9ECBFF" })}">&quot;24px&quot;</span><span style="${ssrRenderStyle({ "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" })}"> /&gt;</span></span>
...
<span class="line"><span style="${ssrRenderStyle({ "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" })}">&lt;/</span><span style="${ssrRenderStyle({ "--shiki-light": "#22863A", "--shiki-dark": "#85E89D" })}">template</span><span style="${ssrRenderStyle({ "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" })}">&gt;</span></span></code></pre></div><h2 id="图标列表" tabindex="-1">图标列表 <a class="header-anchor" href="#图标列表" aria-label="Permalink to &quot;图标列表&quot;">​</a></h2>`);
      _push(ssrRenderComponent(_component_ImRow, { class: "icon-list" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            ssrRenderList(unref(iconData).glyphs, (item, index) => {
              _push2(ssrRenderComponent(_component_ImCol, {
                key: index,
                span: "5"
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div${ssrRenderAttrs(mergeProps({ class: "icon-item" }, ssrGetDirectiveProps(_ctx, _directive_ripple, true)))}${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_ImIcon, {
                      name: item.font_class,
                      size: "36px"
                    }, null, _parent3, _scopeId2));
                    _push3(` ${ssrInterpolate(item.font_class)}</div>`);
                  } else {
                    return [
                      withDirectives((openBlock(), createBlock("div", { class: "icon-item" }, [
                        createVNode(_component_ImIcon, {
                          name: item.font_class,
                          size: "36px"
                        }, null, 8, ["name"]),
                        createTextVNode(" " + toDisplayString(item.font_class), 1)
                      ])), [
            ...
            return [
              (openBlock(true), createBlock(Fragment, null, renderList(unref(iconData).glyphs, (item, index) => {
                return openBlock(), createBlock(_component_ImCol, {
                  key: index,
                  span: "5"
                }, {
                  default: withCtx(() => [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("icon.md");
