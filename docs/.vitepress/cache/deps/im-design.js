...
// node_modules/.pnpm/im-design@0.0.1/node_modules/im-design/dist/im-design.js
var k = (n) => {
  throw TypeError(n);
};
var B = (n, t, e) => t.has(n) || k("Cannot " + e);
var y = (n, t, e) => (B(n, t, "read from private field"), e ? e.call(n) : t.get(n));
var L = (n, t, e) => t.has(n) ? k("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(n) : t.set(n, e);
var N = (n, t, e, s) => (B(n, t, "write to private field"), s ? s.call(n, e) : t.set(n, e), e);
...
var ne = { render: R };
var fe = Object.freeze(Object.defineProperty({
  __proto__: null,
  default: ne,
  render: R
...
function E(n, t) {
  return openBlock(), createElementBlock("svg", oe, t[0] || (t[0] = [
...
var se = { render: E };
var _e = Object.freeze(Object.defineProperty({
  __proto__: null,
  default: se,
  render: E
}, Symbol.toStringTag, { value: "Module" }));
...
function P(n, t) {
  return openBlock(), createElementBlock("svg", ce, t[0] || (t[0] = [
...
var v = defineComponent({
  ...
  emits: ["click"],
  setup(n, { emit: t }) {
    const e = n, s = t, o = C("button"), { sizeToken: i } = ee(), h = computed(() => [
      o.b(),
      e.color && o.m(e.color),
      e.shape && o.m(e.shape),
    ...
    return (u, $) => {
      ...
      return withDirectives((openBlock(), createElementBlock("button", {
        ...
        l.value ? createCommentVNode("", true) : renderSlot(u.$slots, "default", { key: 1 }, () => [
...
var w = defineComponent({
  ...
  setup(n) {
    ...
    return (i, h) => (openBlock(), createElementBlock("div", {
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList(s.value, (r, l) => (openBlock(), createBlock(resolveDynamicComponent(r), { key: l }))), 128))
    ], 6));
  }
});
